...
public class DatabaseOperations {
    ...
    public static Set<String> deleteUsers_B = new HashSet<>();
    public static Set<String> deleteUsers_G = new HashSet<>();
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (toAdd) {
                    ...
                    AlertBox.builder(context, "Success", MainActivity.friendUserName+" is added to your Room", "OK");
                }
            }
